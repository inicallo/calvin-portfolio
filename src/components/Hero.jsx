import img1 from "../../filefoto/Calvin.png"
            ...
            <div className="flex flex-wrap -mt-10">
              ...
              <div className="w-full self-end px-4 lg:w-1/2">
                <div className="relative mt-10">
                  <img src={img1} alt="calvin angelo" className="max-w-full mx-auto" />
                  <span className="absolute -top-28 -z-10 lg:-left-2 md:left-24 -left-9 translate-x-1">
                  <svg className="w-[350px] md:w-[550px]" height="500" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
