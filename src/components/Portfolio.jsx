...
export default function Portfolio() {
    ...
    <div className="w-full px-4 flex flex-wrap justify-center xl:w-10/12 xl:mx-auto">
        <div className="mb-12 p-4 md:w-5/12">
            <img src="filefoto/portfoto/FoodProduct.jpg" alt="Food Product" className="w-full rounded-md" />
        ...
        <div className="mb-12 p-4 md:w-5/12">
            <img src="filefoto/portfoto/Property.JPG" alt="Property" className="w-full rounded-md" />
        ...
        <div className="mb-12 p-4 md:w-5/12">
            <img src="filefoto/portfoto/NPL-VeloRubyBerry.jpg" alt="Food Product" className="w-full rounded-md" />
        ...
        <div className="mb-12 p-4 md:w-5/12">
            <img src="filefoto/portfoto/Garuda_Bot_at_DWP_2017.jpg" alt="Food Product" className="w-full rounded-md" />
